...
import {Apis, ChainConfig} from "saturnjs-ws";
...
describe("issue13", function() {
    ...
    it("should fixed", function() {
        ...
        return Apis.instance(
            "wss://saturnjs.openledger.info/ws",
            true
        ).init_promise.then(() => {
            var b = ops.transaction.toBuffer(a);
            // get from backend. remove signatures. see https://github.com/saturnjs/saturnjs/issues/13#issuecomment-348684435
            var c =
